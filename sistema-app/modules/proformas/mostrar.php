...
$user = $_user['persona_id'];

// Obtiene las ventas

$proformas = $db->query("SELECT i.*,a.almacen,a.principal,e.nombres,e.paterno,e.materno 
                        ...
                        WHERE i.empleado_id = '$user' 
                        AND i.convertido='no_convertido'
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
				    <a href="?/operaciones/seleccionar_sucursal_factura/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Convertir en facturar"><i class="glyphicon glyphicon-qrcode"></i></a>
                    <a href="?/operaciones/seleccionar_sucursal/<?= $proforma['id_proforma']; ?>" data-toggle="tooltip" data-title="Convertir en nota de remision"><i class="glyphicon glyphicon-file"></i></a>
