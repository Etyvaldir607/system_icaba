	...
	<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
		...
		<tfoot>
			<tr class="active">
				...
				<th class="text-nowrap align-middle" data-datafilter-filter="true">CI</th>
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Teléfono</th>
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Correo electrónico</th>
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Institución</th>
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Fecha graduación</th>
