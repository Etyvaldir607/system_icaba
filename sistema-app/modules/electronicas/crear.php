	...
	<div class="col-md-6">
		...
		<div class="panel panel-primary" data-formato="<?= strtoupper($formato_textual); ?>">
			...
			<div class="panel-body">
				...
				<h2 class="lead text-primary">Ventas computarizadas</h2>
		...
		<div class="panel panel-primary" data-servidor="<?= ip_local . name_project . '/factura.php'; ?>">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p class="text-right">
					...
					<a href="?/electronicas/mostrar" class="btn btn-primary">Mis ventas computarizadas</a>

				</p>

				<?php endif ?>

				<form method="post" action="?/electronicas/buscar/<?php echo $id_almacen; ?>" id="form_buscar_0" class="margin-bottom" autocomplete="off">
				...
				<form method="post" action="?/electronicas/buscar/<?php echo $id_almacen; ?>" id="form_buscar_1" class="margin-bottom" autocomplete="off">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				...
				<div class="alert alert-danger">
					...
					<p>Usted no puede realizar la venta, verifique que la siguiente información sea correcta:</p>
				...
				if (productos.length) {
					...
					for (var i in productos) {
						...
						for (var j= 0 ; j < id_asignacion.length; j++){
							...
							listas += '<span data-precio-asignacion="'+ id_asignacion[j] +'">'+ parseFloat(des_unidad[1]).toFixed(2) +'</span> Bs. ';

							listas += '<button type="button" class="btn btn-sm btn-primary" data-vender="'+ productos[i].id_producto+'" data-id-producto="'+ productos[i].id_producto +'" data-id-asignacion="'+ id_asignacion[j] +'" onclick="vender(this); "><span class="glyphicon glyphicon-shopping-cart"></span></button></p>';
...
function imprimir_factura(venta) {	
	...
	window.open('?/electronicas/imprimir/' + venta, '_blank');
