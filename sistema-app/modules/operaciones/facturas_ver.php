...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/operaciones/proformas_imprimir/<?= $venta['id_egreso']; ?>" class="btn btn-default" target="_blank"><i class="glyphicon glyphicon-file"></i><span class="hidden-xs"> Exportar</span></a>
			<?php } ?>
...
$(function () {
	...
	$('[data-reimprimir]').on('click', function () {
		$('#loader').fadeIn(100);
        window.open('?/electronicas/imprimir/' + id_venta, '_blank');
// 		$.ajax({
// 			type: 'post',
// 			dataType: 'json',
