...
<div class="panel-body">
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover">
		...
		<tfoot>
			<tr class="active">
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Menú</th>
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Ícono</th>
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Ruta</th>
