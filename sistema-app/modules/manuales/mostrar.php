...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/manuales/crear" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span><span class="hidden-xs"> Ventas manuales</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">Ventas manuales</td>
	...
	<div class="alert alert-danger">
		...
		<p>No existen ventas manuales registradas en la base de datos.</p>
	</div>
	<?php } ?>
</div>
...
$(function () {	
	...
	$('[data-eliminar]').on('click', function (e) {
		...
		bootbox.confirm('Está seguro que desea eliminar la venta manual y todo su detalle?', function (result) {
			if(result){
				window.location = url;
			}
		});
