	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-9 text-right">
            ...
            <?php if ($permiso_facturar) { ?>
                <a href="?/electronicas/facturar/<?= $proforma['id_proforma']; ?>" class="btn btn-success"><i class="glyphicon glyphicon-qrcode"></i><span class="hidden-xs hidden-sm"> Facturar</span></a>
            <?php } ?>
			...
			<a href="?/operaciones/proformas_listar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm"> Proformas</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
						...
						<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-nowrap text-right"><?= $detalle['unidad']; ?></td>
							...
							<tfoot>
								<tr class="active">
									<th class="text-nowrap" colspan="7">Importe total <?= escape($moneda); ?></th>
...
<div id="modal_cliente" class="modal fade">
	<div class="modal-dialog">
		<form method="post" action="?/operaciones/proformas_editar" id="form_cliente" class="modal-content">
...
$(function () {
	...
	$('[data-reimprimir]').on('click', function () {
		$('#loader').fadeIn(100);
        window.open('?/proformas/imprimir/' + id_proforma, '_blank');
// 		$.ajax({
// 			type: 'post',
// 			dataType: 'json',
