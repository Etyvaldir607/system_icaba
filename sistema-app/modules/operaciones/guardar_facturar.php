...
// 		$nro_factura = $nro_factura['nro_factura'];
		...
		$dosificacion = $db->query("select * from inv_dosificaciones 
									where fecha_registro <= '$hoy' AND fecha_limite >='$hoy' AND activo = 'S' and sucursal_id = '$sucursal_id'")->fetch_first();
		// // Verifica si la dosificaci贸n existe
		...
		$nota = array(
			...
			'tipo' => 'Venta',
			'provisionado' => 'N',
			'descripcion' => 'Venta de productos CONVERTIDO DE PROFORMA',
