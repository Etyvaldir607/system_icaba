				...
				<form id="formulario" class="form-horizontal">
					...
					<div class="table-responsive margin-none">
						<table id="ventas" class="table table-bordered table-condensed table-striped table-hover margin-none">
							<thead>
								<tr class="active">
									<th class="text-nowrap align-middle text-center width-collapse">#</th>
									<th class="text-nowrap align-middle text-center width-collapse">Código</th>
									<th class="text-nowrap align-middle text-center">Producto</th>
									<th class="text-nowrap align-middle text-center width-collapse">Cantidad</th>
									<th class="text-nowrap align-middle text-center width-collapse">Precio</th>
									<th class="text-nowrap align-middle text-center width-collapse">Descuento</th>
									<th class="text-nowrap align-middle text-center width-collapse">Importe</th>
									<th class="text-nowrap align-middle text-center width-collapse">Acciones</th>
								</tr>
							</thead>
							<tfoot>
								<tr class="active">
...
<div id="tabla_filtrar" class="hidden">
	<div class="table-responsive">
		<table class="table table-bordered table-condensed table-striped table-hover">
			<thead>
				<tr class="active">
					<th class="text-nowrap align-middle text-center width-collapse">Imagen</th>
					<th class="text-nowrap align-middle text-center width-collapse">Código</th>
					<th class="text-nowrap align-middle text-center">Producto</th>
					<th class="text-nowrap align-middle text-center width-collapse">Categoría</th>
					<th class="text-nowrap align-middle text-center width-collapse">Stock</th>
					<th class="text-nowrap align-middle text-center width-collapse">Precio</th>
					<th class="text-nowrap align-middle text-center width-collapse">Acciones</th>
				</tr>
			</thead>
...
<table class="hidden">
	<tbody id="fila_filtrar" data-negativo="<?= imgs; ?>/" data-positivo="<?= files; ?>/productos/">
		<tr>
			<td class="text-nowrap align-middle text-center width-collapse">
			...
			<td class="text-nowrap align-middle text-right lead" data-stock=""></td>
			<td class="text-nowrap align-middle text-right lead" data-valor=""></td>
			<td class="text-nowrap align-middle text-center width-collapse">
