...
<div class="panel-heading" data-venta="<?= $id_venta; ?>" data-servidor="<?= ip_local . 'sistema/nota.php'; ?>">
...
<div class="panel-body">
	<?php if ($permiso_reimprimir || $permiso_editar || $permiso_listar) { ?>
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
		 <!--   <?php if ($permiso_editar) : ?>-->
			...
			<!--		<a href="?/cobrar/notas_ver/<?= $venta['id_egreso']; ?>" class="btn btn-danger" class="btn btn-default">El cliente tiene deudas pendientes (Cobrar deuda)</a>-->
			<!--    <?php } ?>-->
			<!--<?php endif ?>-->
			...
			<a href="?/operaciones/notas_listar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm hidden-md"> Notas de remisión</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
...
<div id="modal_cliente" class="modal fade">
	<div class="modal-dialog">
		<form method="post" action="?/operaciones/notas_editar" id="form_cliente" class="modal-content">
