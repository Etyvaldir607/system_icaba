		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap align-middle">
					<?php if ($permiso_ver) { ?>
					<a href="?/categorias/ver/<?= $categoria['id_categoria']; ?>" data-toggle="tooltip" title="Ver categoría">
						<span class="glyphicon glyphicon-search"></span>
					</a>
					<?php } ?>
					<?php if ($permiso_editar) { ?>
					<a href="?/categorias/editar/<?= $categoria['id_categoria']; ?>" data-toggle="tooltip" title="Modificar categoría"><span class="glyphicon glyphicon-edit"></span></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/categorias/eliminar/<?= $categoria['id_categoria']; ?>" data-toggle="tooltip" title="Eliminar categoría" data-eliminar="true"><span class="glyphicon glyphicon-trash"></span></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
