...
if($permiso_sucursal){
	...
	if($id_sucursal==0){
		...
		header("Location: ?/manuales/seleccionar_sucursal");
	...
	$id_sucursal = ($almacen) ? $almacen['id_sucursal'] : 0;
...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="panel panel-success" data-formato="<?= strtoupper($formato_textual); ?>">
			...
			<div class="panel-body">
				...
				<h2 class="lead text-success">Ventas manuales</h2>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<select name="cliente" id="cliente" class="form-control text-uppercase" data-validation="letternumber" data-validation-allowing="-+./&() " data-validation-optional="true">
								...
								<option value="<?= escape($cliente['nit_ci']) . '|' . escape($cliente['nombre_cliente']) . '|' . escape($cliente['telefono']) . '|' . escape($cliente['escalafon']) . '|' . escape($cliente['pago']); ?>"><?= escape($cliente['nit_ci']) . ' &mdash; ' . escape($cliente['nombre_cliente']); ?></option>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<p class="text-right">
					...
					<a href="?/manuales/mostrar" class="btn btn-success">Mis ventas manuales</a>
				...
				<form method="post" action="?/manuales/buscar/<?php echo $id_almacen; ?>" id="form_buscar_0" class="margin-bottom" autocomplete="off">
				...
				<form method="post" action="?/manuales/buscar/<?php echo $id_almacen; ?>" id="form_buscar_1" class="margin-bottom" autocomplete="off">
...
<div id="modal_mostrar" class="modal fade" tabindex="-1">	<div class="modal-dialog">
				...
				if (productos.length) {
					...
					for (var i in productos) {
						...
						for (var j= 0 ; j < id_asignacion.length; j++){
							...
							listas += '<button type="button" class="btn btn-sm btn-success" data-vender="'+ productos[i].id_producto+'" data-id-producto="'+ productos[i].id_producto +'" data-id-asignacion="'+ id_asignacion[j] +'" onclick="vender(this); "><span class="glyphicon glyphicon-shopping-cart"></span></button> <button type="button" class="btn btn-sm btn-default" data-actualizar-producto="'+productos[i].id_producto+'" data-actualizar="'+id_asignacion[j]+'" onclick="actualizar(this);"><span class="glyphicon glyphicon-refresh"></span></button></p>';

							/*listas += '<button type="button" class="btn btn-warning" data-vender="'+ productos[i].id_producto+'" data-id-producto="'+ productos[i].id_producto +'" data-id-asignacion="'+ id_asignacion[j] +'" onclick="vender(this); ">Vender</button> <button type="button" class="btn btn-default" data-actualizar="" onclick="actualizar(this);calcular_descuento()">Actualizar</button></p>';*/
