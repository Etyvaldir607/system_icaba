					...
					<tbody>
						...
						<tr>
							...
							<td class="text-nowrap text-right" data-valor="<?= $producto['id_producto']; ?>">
								...
								if($primera_asignacion==-1){
									$primera_asignacion=$asignacion['id_asignacion'];
								}
							...
							if( $producto['cantidad_ingresos'] - $producto['cantidad_egresos']>0 ){
								...
								$cantidadx=$producto['cantidad_ingresos'] - $producto['cantidad_egresos'];
								
								$detalle = array(
									'cantidad' => $cantidadx,
									'precio' => 0,
									'asignacion_id' => $primera_asignacion,
									'descuento' => 0,
