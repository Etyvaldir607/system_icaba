			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div class="form-horizontal">
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Almacén de salida:</label>
							<div class="col-md-9">
								<p class="form-control-static"><?= escape($egreso['almacen']) ?></p>
							</div>
						</div>
						...
						if($egreso['tipo']=="Traspaso"){
							$ingreso = $db->select('a.almacen, resp.nombres as nombres_resp, resp.paterno as paterno_resp,resp.materno as materno_resp')
									  ->from('inv_ingresos i')
									  ->join('inv_almacenes a', 'i.almacen_id = a.id_almacen', 'left')
							...
							?>
							<div class="form-group">
								<label class="col-md-3 control-label">Almacén de ingreso:</label>
								<div class="col-md-9">
									<p class="form-control-static"><?= $almacen222; ?></p>
								</div>
							</div>
						<?php
						}
						...
						<div class="form-group">
							<label class="col-md-3 control-label">Responsable Salida:</label>
							<div class="col-md-9">
								<p class="form-control-static"><?= escape($egreso['nombres_resp'] . ' ' . $egreso['paterno_resp'] . ' ' . $egreso['materno_resp']); ?></p>
							</div>
						</div>
						<?php if($egreso['tipo']=="Traspaso"){ ?>
						<div class="form-group">
							<label class="col-md-3 control-label">Responsable Ingreso:</label>
							<div class="col-md-9">
								<p class="form-control-static"><?= escape($ingreso['nombres_resp'] . ' ' . $ingreso['paterno_resp'] . ' ' . $ingreso['materno_resp']); ?></p>
							</div>
						</div>
						<?php } ?>
						<div class="form-group">
