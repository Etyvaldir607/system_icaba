...
// 	var_dump('proforma: '.$id_proforma.'< proforma: '.$proforma['empleado_id'].'< user: '.$_user['persona_id']);die();
	// Error 404
...
$detalles = $db->query("SELECT d.*, p.codigo, p.nombre, p.nombre_factura, u.unidad
