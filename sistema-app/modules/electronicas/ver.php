...
<div class="panel-heading" data-venta="<?= $id_venta; ?>" data-servidor="<?= ip_local . 'servidor/nota.php'; ?>">
	<h3 class="panel-title">
		...
		<strong>Detalle de venta computarizada</strong>
	</h3>
</div>
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/electronicas/imprimir/<?= $id_venta; ?>" target="_blank" class="btn btn-default"><i class="glyphicon glyphicon-file"></i><span class="hidden-xs hidden-sm"> Exportar</span></a>
			<?php } ?>
			...
			<a href="?/electronicas/mostrar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm hidden-md"> Listado</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
		...
		<div class="col-sm-10 col-sm-offset-1">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title"><i class="glyphicon glyphicon-list"></i> Detalle de venta computarizada</h3>
				</div>
				<div class="panel-body">
					<?php if ($detalles) { ?>
