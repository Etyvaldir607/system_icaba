...
<div class="panel-body">
	...
	<div class="row">
		<div class="col-sm-4 col-md-3">
			<img src="<?= ($_institution['imagen_encabezado'] == '') ? imgs . '/picture.jpg' : institucion . '/' . $_institution['imagen_encabezado']; ?>" class="img-responsive cursor-pointer" data-toggle="modal" data-target="#modal_mostrar" data-modal-size="modal-lg" data-modal-title="Logotipo">
		</div>
				...
				<div class="table-display">
					<div class="tbody">
						<div class="tr">
							...
							<div class="td text-truncate"><?= escape($_institution['pie_pagina']); ?></div>
						</div>
					</div>
				</div>
			</div>
