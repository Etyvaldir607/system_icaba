	...
	<form method="post" action="?/permisos/guardar" class="form-horizontal">
		...
		<div class="table-responsive">
			<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
				<thead>
					<tr class="active">
						<th class="text-nowrap align-middle column-collapse">Menú</th>
						<th class="text-nowrap align-middle column-collapse">Estado</th>
						<th class="text-nowrap align-middle">Permisos</th>
					</tr>
				</thead>
				<tbody>
					...
					<tr class="treegrid-<?= $menu['id_menu']; ?> <?= ($menu['antecesor_id'] == 0) ? '' : 'treegrid-parent-' . $menu['antecesor_id']; ?>">
						<td class="text-nowrap align-middle">
							<span class="glyphicon glyphicon-<?= $menu['icono']; ?>"></span>
						...
						<td class="align-middle">
							...
							<small>
								<span class="text-primary">[<?= escape($menu['modulo']); ?>]</span>
								<span>disponibles:</span>
								<span class="text-success"><?= $files; ?></span>
							</small>
							<?php } ?>
						</td>
					</tr>
