...
if (!$permiso_almacen) {
	header("Location: ?/electronicas/crear");
}
	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<?php if ($permiso_mostrar) : ?>
				<br>
				<p class="text-right">
					<a href="?/electronicas/mostrar" class="btn btn-warning">Mis ventas computarizadas</a>
				</p>
			<?php endif ?>
			...
			<div class="panel-body">
				...
				?>
					<div class="col-md-4">
						<a class="seleccionarAlmacen" href="?/electronicas/crear/<?php echo $almacenX["id_sucursal"]; ?>">
							<div class="panel panel-default">
								<div class="panel-heading">
