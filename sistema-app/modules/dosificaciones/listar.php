...
$dosificaciones = $db->from('inv_dosificaciones')
					->join('inv_sucursal', 'id_sucursal=sucursal_id', 'left')
	...
	<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
		...
		<tfoot>
			<tr class="active">
				...
				<th class="text-nowrap align-middle">Fecha de registro</th>
				<th class="text-nowrap align-middle">Sucursal</th>
				<th class="text-nowrap align-middle">Número de trámite</th>
				<th class="text-nowrap align-middle">Número de autorización</th>
				<th class="text-nowrap align-middle" data-datafilter-visible="false">Llave de dosificación</th>
				<th class="text-nowrap align-middle">Fecha límite de emisión</th>
				<th class="text-nowrap align-middle">Leyenda</th>
				<th class="text-nowrap align-middle" data-datafilter-visible="false">Observación</th>
				<th class="text-nowrap align-middle">Estado</th>
				<th class="text-nowrap align-middle">Días restantes</th>
				<th class="text-nowrap align-middle">Facturas</th>
				<?php if ($permiso_bloquear || $permiso_ver || $permiso_editar || $permiso_eliminar) { ?>
		...
		<tbody>
			...
			<tr>
				...
				<td><?= escape($dosificacion['sucursal']); ?></td>
