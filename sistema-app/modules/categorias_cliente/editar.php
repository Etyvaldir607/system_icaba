...
$categoria = $db->select('z.*')->from('inv_categorias_cliente z')->where('z.id_categoria_cliente', $id_categoria_cliente)->fetch_first();
...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<?php } ?>
			<?php if ($permiso_ver) { ?>
			<a href="?/categorias_cliente/ver/<?= $categoria['id_categoria_cliente']; ?>" class="btn btn-warning">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			<form method="post" action="?/categorias_cliente/guardar" class="form-horizontal">
				<div class="form-group">
					<label for="categoria" class="col-md-3 control-label">Categoría:</label>
					<div class="col-md-9">
						<input type="hidden" value="<?= $categoria['id_categoria_cliente']; ?>" name="id_categoria_cliente" data-validation="required">
