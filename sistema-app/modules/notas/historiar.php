...
// Obtiene los egresos
$egresos = $db->select('i.*, e.nombres, e.paterno, e.materno')
				->from('his_egresos i')
...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-4 text-right">
			...
			<a href="?/egresos/listar" class="btn btn-primary"><span class="glyphicon glyphicon-list"></span><span class="hidden-xs"> Listar</span></a>
			<?php } ?>
			<?php if ($permiso_imprimir) { ?>
			<a href="?/egresos/imprimir" target="_blank" class="btn btn-info"><i class="glyphicon glyphicon-print"></i><span class="hidden-xs"> Imprimir</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap"><?= escape(date_decode($egreso['fecha'], $_institution['formato'])); ?> <small class="text-success"><?= escape($egreso['hora']); ?></small></td>
...
$(function () {
	...
	$.validate({
		...
		onSuccess: function () {
			...
			window.location = '?/egresos/historiar' + inicial_fecha + final_fecha;
		}
	});
