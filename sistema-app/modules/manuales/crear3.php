				...
				if (productos.length) {
					...
					for (var i in productos) {
						...
						for (var j= 0 ; j < id_asignacion.length; j++){
							...
							listas += '<span data-precio-asignacion="'+ id_asignacion[j] +'">'+ des_unidad[1] +'</span> Bs. ';
							...
							//listas += '<button class=" btn btn-success btn-sm" data-cotizar="'+ productos[i].id_producto+'" data-id-producto="'+ productos[i].id_producto +'" data-id-asignacion="'+ id_asignacion[j] +'" onclick="cotizar(this)">Cotizar</button><br><br>';
						}
