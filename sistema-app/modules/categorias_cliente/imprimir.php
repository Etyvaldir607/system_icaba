...
if ($id_categoria_cliente == 0) {
	...
	->order_by('z.id_categoria_cliente')
	->fetch();
} else {
...
if ($id_categoria_cliente == 0) {
	...
	$pdf->Cell(0, 10, 'LISTA DE CATEGORÍAS CLIENTES', 0, true, 'C', false, '', 0, false, 'T', 'M');
...
EOD;
	...
	$pdf->Cell(0, 5, 'ID: ' . $id_categoria_cliente, 0, true, 'C', false, '', 0, false, 'T', 'M');
...
EOD;
	...
	// Genera el nombre del archivo
	$nombre = 'categoria_' . $id_categoria_cliente . '_' . date('Y-m-d_H-i-s') . '.pdf';
}
