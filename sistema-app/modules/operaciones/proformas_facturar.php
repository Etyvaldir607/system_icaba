		...
		<div class="panel panel-warning" data-formato="<?= strtoupper($formato_textual); ?>">
			<div class="panel-heading">
				<h3 class="panel-title">
					...
					<strong>Ventas computarizadas</strong>
				</h3>
			</div>
			<div class="panel-body">
				<h2 class="lead text-warning">Ventas computarizadas</h2>
				<hr>
				<form id="formulario" class="form-horizontal" data-locked="false">
					...
					<div class="form-group">
						<div class="col-xs-12">
							...
							<input type="text" name="monto_porcentaje" value="<?= $totalDescuento; ?>" class="translate" tabindex="-1" data-porcentaje="" data-validation="required number" data-validation-allowing="range[0.01;<?= $limite_monetario; ?>],float" data-validation-error-msg="El monto total de la venta debe ser mayor a cero y menor a <?= $limite_monetario; ?>">
		...
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="alert alert-danger">
					<p>Usted no puede realizar la Ventas computarizadas, verifique que la siguiente información sea correcta:</p>
					<ul>
...
function guardar_nota(form) {
	...
	if ($form.data('locked') != undefined && !$form.data('locked')) {
		...
		$.ajax({
		    type: 'post',
		    dataType: 'json',
		    url: '?/operaciones/guardar_facturar',
		    data: data,
		    beforeSend: function() {
		    ...
		    if (venta) {
		        $.notify({
		            message: 'La venta con Ventas computarizadas fue realizada satisfactoriamente.'
		        }, {
		            type: 'success'
		        });
		        ...
		        $('#loader').fadeOut(100);
		        $.notify({
		            message: 'Ocurrió un problema en el proceso de facturación, la venta no cuenta con una dosificación, no se pudo guardar los datos de la venta, verifique su conexion a internet.'
		        }, {
		            type: 'danger'
		        });
		    	$form.data('locked', false);
