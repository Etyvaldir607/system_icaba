	...
	<table id="table" class="table table-bordered table-condensed table-striped table-hover table-xs">
		...
		<tfoot>
			<tr class="active">
				...
				<th class="text-nowrap align-middle" data-datafilter-filter="true">Almacén</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-nowrap">
					<?php if ($permiso_ver) { ?>
					<a href="?/egresos/ver/<?= $egreso['id_egreso']; ?>" data-toggle="tooltip" data-title="Ver detalle"><i class="glyphicon glyphicon-list-alt"></i></a>
					<?php } ?>
					<?php if ($permiso_eliminar) { ?>
					<a href="?/egresos/eliminar/<?= $egreso['id_egreso']; ?>" data-toggle="tooltip" data-title="Eliminar egreso" data-eliminar="true"><i class="glyphicon glyphicon-trash"></i></a>
					<?php } ?>
				</td>
				<?php } ?>
			</tr>
