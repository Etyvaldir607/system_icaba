	...
	if (isset($params)) {
		...
		if (isset($_POST['busqueda'])) {
            ...
            $productos = $db->query("SELECT
                                    ...
                                    GROUP_CONCAT(DISTINCT z.id_asignacion ORDER BY z.tamanio ASC SEPARATOR '|') AS id_asignacion,
                                    GROUP_CONCAT(DISTINCT z.unidad_id ORDER BY z.tamanio ASC SEPARATOR '|') AS unidad_id,
                                    GROUP_CONCAT(DISTINCT
                                          z.unidad,
                                          ':',
                                          z.precio_actual2 ORDER BY z.tamanio ASC SEPARATOR '&'
                                    ) AS unidad_descripcion,
                                    GROUP_CONCAT(DISTINCT z.tamanio ORDER BY z.tamanio ASC SEPARATOR '|') AS tamanio
