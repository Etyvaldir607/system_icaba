		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="alert alert-info">
					...
					<ul>
						<li>Elija el almacen desde el quiere realizar el egreso.</li>
					</ul>
				</div>
					<?php
					...
					<div class="col-md-4">
						<a class="seleccionarAlmacen" href="?/egresos/crear/<?= $almacen["id_almacen"]; ?>">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h2 class="panel-title d-block text-center">
										<strong><?= $almacen["sucursal"]; ?></strong>
										<br>
