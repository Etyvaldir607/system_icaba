...
<div class="panel-body">
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-5 col-md-6 text-right">
			...
			<a href="?/manuales/imprimir/<?= $id_venta; ?>" target="_blank" class="btn btn-default"><i class="glyphicon glyphicon-file"></i><span class="hidden-xs hidden-sm"> Exportar</span></a>
			<?php } ?>
			...
			<a href="?/manuales/mostrar" class="btn btn-primary"><i class="glyphicon glyphicon-list-alt"></i><span class="hidden-xs hidden-sm hidden-md"> Ventas manuales</span></a>
			<?php } ?>
		</div>
	</div>
	<hr>
			...
			<div class="panel panel-primary">
				...
				<div class="panel-body">
						...
						<table id="table" class="table table-bordered table-condensed table-restructured table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-nowrap text-right hidden"><?= $detalle['descuento']; ?></td>
					...
					<div class="alert alert-danger">
						...
						<p>Esta venta manual no tiene detalle, es muy importante que todos los egresos cuenten con un detalle que especifique la operación realizada.</p>
					</div>
					<?php } ?>
				</div>
			</div>
	...
	$('[data-reimprimir]').on('click', function () {
		...
		$.ajax({
			...
			if (venta) {
				...
				$.notify({
					title: '<strong>Error!</strong>',
					message: '<div>Ocurrió un problema al obtener los datos de la venta_manual.</div>'
				}, {
					type: 'danger'
				});
			}
			...
			$.notify({
				title: '<strong>Error!</strong>',
				message: '<div>Ocurrió un problema al obtener los datos de la venta manual.</div>'
			}, {
				type: 'danger'
			});
		});
